...
public class EmployeeOperationController 
{
   ...
   @GetMapping("/report")
   public String getReport(Map<String,Object>map,@ModelAttribute("emp")Employee emp) 
   {
	   List<Employee>list=empMgmt.showAllEmployee();
...
//=======================Search=======================
  ...
  @PostMapping("/dynamic")
  public String searchDynamic(@RequestParam(required = false)Integer d1,
		  @RequestParam(required = false)Integer d2,@RequestParam (required = false)Integer d3,Map<String, Object>map,@ModelAttribute("emp")Employee emp) 
  {
	  
	      List<Employee>list   = empMgmt.dynamicEmployee(d1, d2, d3 ,emp);
	  map.put("empdata", list);
